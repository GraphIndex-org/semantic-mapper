...
table, use the other columns and the provided sample values to infer the meaning of each column.
...
table, use the other columns to infer the meaning of each provided column.
You will be provided with segments from the target ontology given in a JSON format. 
The target ontology may be very long and you will only see a portion of it.
...
mappings of the table column to a target ontology. Your task is to answer any question about the table and mappings.
