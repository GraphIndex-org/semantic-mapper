...
*** IF A COLUMN IN TWO DIFFERENT TABLES HAS A SIMILAR NAME THAT STARTS WITH A TABLE NAME FOLLOWED BY WORDS SUCH AS ID, 
CODE, AND SIMILAR, THEN IT'S PROBABLY A PRIMARY KEY IN ONE OR MORE TABLES AND A 
